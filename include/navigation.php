        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fas fa-box-open"></i> Stock & Commandes <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="stock_produit.php?source=stock">Stock</a>
                            </li>
                            <li>
                                <a href="stock_produit.php?source=achat">Les Achats</a>
                            </li>
                            <li>
                                <a href="stock_produit.php?source=commande">Commandes</a>
                            </li>
                        </ul>
                    </li>
                    <li>
